...
router.get('/settings/info', login_Check, api_Controller.api_getSettinginfo);
router.get('/settings', login_Check, api_Controller.api_getSettingConfig);
...
router.put('/settings/password', login_Check, api_Controller.api_putSettingPassword);
router.put('/settings/nickname', login_Check, api_Controller.api_putSettingNickname);
router.put('/settings/social', login_Check, api_Controller.api_putSettingSocial);
