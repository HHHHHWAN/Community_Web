...
const CommentDOMsetting = (function () {
    ...
    const commnet_button_object = comment_root_div.querySelector('.comment_submit');


    const comment_submit =  ( el ) => {
    ...
    comment_submit(commnet_button_object);

    comment_root_div.querySelectorAll('.create_subcomment_button').forEach(button => { 
        button.addEventListener('click',function(){
            ...
            if( form_div.children.length === 0 ){
                ...
                form_div.innerHTML = `
                        <div class='comment_tag' style = "margin-bottom : 10px ;"></div>
